            ...
            Map<String, Object> body = Map.of(
                    ...
                    "messages", List.of(
                            Map.of("role", "user", "content",
                                    "Твоя задача дать на основе информации(навыки, интересы, образование) после двоеточий название подходящей должности, и через ; разделить и написать описание, разделить еще раз и написать по 4-5 шкале(с плавающей точкой) то, насколько именно эта должность подходит человеку: "
